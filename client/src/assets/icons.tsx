export const mediumLogo = (
  <span style={{ fontWeight: "bold", fontSize: "28px", fontFamily: "serif", color: "black", letterSpacing: "-1px" }}>
    NowScripts
  </span>
);
...
export const completeLogo = (
  <span style={{ fontWeight: "bold", fontSize: "36px", fontFamily: "serif", color: "black", letterSpacing: "-1.5px" }}>
    NowScripts
  </span>
);
